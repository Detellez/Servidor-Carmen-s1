(function() {
    ...
    // ==========================================
    const CEREBRO_URL = 'https://script.google.com/macros/s/AKfycbwmvvUWJhV8QkfrVjKJ0MMJAL9rdzJ3jFkSb-k5z9hzDpnwC5wiawPUesmQ2osMCwM/exec';
    
    // URLs de los Obreros Activos
    const OBRERO_MEXICO_URL = 'https://script.google.com/macros/s/AKfycbwmvvUWJhV8QkfrVjKJ0MMJAL9rdzJ3jFkSb-k5z9hzDpnwC5wiawPUesmQ2osMCwM/exec';
    const OBRERO_PERU_URL = 'https://script.google.com/macros/s/AKfycbwmvvUWJhV8QkfrVjKJ0MMJAL9rdzJ3jFkSb-k5z9hzDpnwC5wiawPUesmQ2osMCwM/exec';
    const OBRERO_BRASIL_URL = 'https://script.google.com/macros/s/AKfycbwmvvUWJhV8QkfrVjKJ0MMJAL9rdzJ3jFkSb-k5z9hzDpnwC5wiawPUesmQ2osMCwM/exec';
    const OBRERO_COLOMBIA_URL = 'https://script.google.com/macros/s/AKfycbwmvvUWJhV8QkfrVjKJ0MMJAL9rdzJ3jFkSb-k5z9hzDpnwC5wiawPUesmQ2osMCwM/exec';
...
function showNotification(message, msgId, type = 'info') {
   ...
   // 🔥 Alerta de Windows NATIVA (Solo en Segundo Plano)
    ...
    function iniciarEscuchaFirebase() {
        ...
        const FIREBASE_URL = "https://sst-notificaciones-carmen-default-rtdb.firebaseio.com/alerta_activa.json";
